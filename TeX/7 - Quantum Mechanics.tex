...
Paper~4, this flow vector is the instantaneous displacement of the coherent
axial-oscillation wave field of a charged particle's bound core ring---a
localized, standing-wave form of the same fundamental spin-wave degree of
freedom that propagates as free electromagnetic radiation.
...
detected?\ Every atom generates a near-field coherent axial-oscillation wave field
around its nucleus (its electric field;
Section~\ref{sec:electric-field}~\cite{otto-em}), whose time-averaged pressure envelope
...
in the free medium.\ The electric field is the coherent axial-oscillation wave field
of the bound core ring (Paper~4~\cite{otto-em}), and every atom generates a structured
...
Every nucleus generates a near-field coherent axial-oscillation wave field (its
...
The compression ratio along the Coulomb curve is
$\approx 5.2\times10^{7}$ ($\log_{10}X \approx 7.71$), about $35\%$ below
the electron-mass-only value above; see Paper~7(a) §10 for the
$f_{\mathrm{core}}$-reconciliation caveat.}
%
...
\begin{enumerate}[leftmargin=2em]
  \item Atoms function as resonant cavities in the Aether, with the nuclear electric field
    (the near-field coherent axial-oscillation wave envelope) creating a pressure gradient
...
\begin{enumerate}[leftmargin=2em]
  ...
  \item \textbf{Quantitative derivation of the near-field pressure profile near a nucleus.}\
    ...
    axial-oscillation wave fields (Paper~4~\cite{otto-em}), combined with the gravitational
